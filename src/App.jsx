    ...
    <div style={{ background: "#fff" }}>
      ...
      <div className="sec solutions" style={{ background: "var(--bg)", borderTop: "1px solid var(--line)", borderBottom: "1px solid var(--line)" }}>
        <div className="wrap" style={{ padding: "72px 24px" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 32 }}>{[{ t: "Placement types", s: "Ways to place talent", items: SOLUTIONS.slice(0, 5) }, { t: "Routes to market", s: "Ways to win and hold contracts", items: SOLUTIONS.slice(5) }].map((grp) => (
            <div key={grp.t}>
              <Reveal><div className="row" style={{ alignItems: "baseline", gap: 12, marginBottom: 16 }}><span className="eyebrow" style={{ color: "#06776F" }}>{grp.t}</span><span className="faint" style={{ fontSize: 12.5 }}>{grp.s}</span><div style={{ flex: 1, height: 1, background: "var(--line)" }} /></div></Reveal>
              <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(232px, 1fr))", gap: 16 }}>{grp.items.map((s, i) => (
                <Reveal key={s.l} delay={i * 50}>
                  <div className="card lift glow-hover" style={{ padding: 22, height: "100%", position: "relative", overflow: "hidden", borderColor: s.lead ? "var(--cyan)" : "var(--line)" }}>
                    <div style={{ position: "absolute", top: 0, left: 0, right: 0, height: 3, background: s.lead ? "linear-gradient(90deg,var(--teal),var(--cyan))" : "linear-gradient(90deg,#2D6BFF,#7C5CFF)" }} />
                    <div className="row" style={{ justifyContent: "space-between", alignItems: "flex-start" }}><div style={{ width: 46, height: 46, borderRadius: 13, background: s.lead ? "var(--cyan-soft)" : "#EEF3FF", display: "grid", placeItems: "center" }}><s.i size={21} color={s.lead ? "#06776F" : "#1E54E6"} /></div>{s.lead ? <span className="chip chip-cyan" style={{ fontSize: 10 }}>Perm-first</span> : null}{s.subtle ? <span className="chip chip-grey" style={{ fontSize: 10 }}>On demand</span> : null}</div>
                    <div style={{ fontWeight: 700, fontSize: 16.5, marginTop: 14 }}>{s.l}</div>
                    <div className="muted" style={{ fontSize: 13, marginTop: 6, lineHeight: 1.55 }}>{s.d}</div>
                  </div>
                </Reveal>
              ))}</div>
            </div>
...
const NAVS = {
  ...
  agency: [
    { k: "dashboard", l: "Dashboard", i: LayoutDashboard }, { k: "feed", l: "Live feed", i: Rss }, { k: "suppliers", l: "Private clinics", i: Package }, { k: "leaderboard", l: "Leaderboard", i: Trophy }, { k: "inbox", l: "Enquiry inbox", i: Inbox }, { k: "opportunities", l: "Opportunities", i: Target }, { k: "savedOpps", l: "Saved", i: Star }, { k: "talentpool", l: "Talent pipeline", i: Users },
  ...
  hospital: [
    { k: "feed", l: "Post & live feed", i: Rss }, { k: "clinicians", l: "Candidate search", i: Stethoscope }, { k: "execs", l: "Executive network", i: Briefcase }, { k: "talentpool", l: "Available talent", i: Users }, { k: "shortlists", l: "My shortlists", i: Heart },
  ...
  clinician: [
    ...
    { k: "clinicianReg", l: "Get verified", i: ShieldCheck }, { k: "liveProjects", l: "Live projects", i: Radar }, { k: "network", l: "Network", i: Users }, { k: "messages", l: "Messages", i: MessageSquare }, { k: "relocation", l: "Relocation", i: Globe }, { k: "news", l: "Industry news", i: Rss },
  ],
  gp: [
