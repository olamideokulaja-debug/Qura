  ...
  return (
    <div style={{ minHeight: "100vh", background: "linear-gradient(180deg,#F3F9FD,#fff)" }}>
      ...
      <div className="wrap" style={{ padding: "10px 24px 60px", textAlign: "center" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(238px,1fr))", gap: 16, textAlign: "left", maxWidth: 1240, margin: "0 auto" }}>{tiers.map((t) => (
