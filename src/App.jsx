...
function DemoBooking({ onHome, onSignIn }) {
  const [done, setDone] = useState(false);
  const [f, setF] = useState({ name: "", org: "", email: "", interest: "agency", date: "", msg: "" });
      ...
      <div className="card reveal" style={{ position: "relative", zIndex: 2, width: "100%", maxWidth: 560, padding: 40 }}>
        {done ? (
          ...
          <>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
              <div><label style={lbl}>I am a</label><select className="in" style={{ width: "100%" }} value={f.interest} onChange={(e) => setF({ ...f, interest: e.target.value })}><option value="agency">Healthcare agency</option><option value="hospital">Hospital / Provider</option><option value="supplier">Medical device supplier</option><option value="clinician">Clinician</option></select></div>
